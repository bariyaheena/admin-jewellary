...
function CardMenu(props) {
  ...
  return (
    <Dropdown
        ...
        <button
          ...
          className={`flex items-center text-xl hover:cursor-pointer ${
            transparent
              ...
              : "bg-lightPrimary p-2 text-brand-500 chart-icon"
      ...
      children={
        <div className="z-50 w-max rounded-xl  py-3 px-4 text-sm shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
